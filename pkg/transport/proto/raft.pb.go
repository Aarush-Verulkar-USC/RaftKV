...
// 	protoc        v6.33.4
// source: pkg/transport/proto/raft.proto
...
type LogEntry struct {
	...
	Command       []byte                 `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"` // Serialized command for the state machine
...
func (x *LogEntry) Reset() {
	*x = LogEntry{}
	mi := &file_pkg_transport_proto_raft_proto_msgTypes[0]
...
func (*LogEntry) Descriptor() ([]byte, []int) {
	return file_pkg_transport_proto_raft_proto_rawDescGZIP(), []int{0}
}
...
type RequestVoteRequest struct {
	...
	CandidateId   uint64                 `protobuf:"varint,2,opt,name=candidate_id,json=candidateId,proto3" json:"candidate_id,omitempty"`      // Candidate requesting vote
...
func (x *RequestVoteRequest) Reset() {
	*x = RequestVoteRequest{}
	mi := &file_pkg_transport_proto_raft_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RequestVoteRequest) Descriptor() ([]byte, []int) {
	return file_pkg_transport_proto_raft_proto_rawDescGZIP(), []int{1}
}
...
func (x *RequestVoteResponse) Reset() {
	*x = RequestVoteResponse{}
	mi := &file_pkg_transport_proto_raft_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RequestVoteResponse) Descriptor() ([]byte, []int) {
	return file_pkg_transport_proto_raft_proto_rawDescGZIP(), []int{2}
}
...
type AppendEntriesRequest struct {
	...
	LeaderId      uint64                 `protobuf:"varint,2,opt,name=leader_id,json=leaderId,proto3" json:"leader_id,omitempty"`               // Leader's ID so follower can redirect clients
...
func (x *AppendEntriesRequest) Reset() {
	*x = AppendEntriesRequest{}
	mi := &file_pkg_transport_proto_raft_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendEntriesRequest) Descriptor() ([]byte, []int) {
	return file_pkg_transport_proto_raft_proto_rawDescGZIP(), []int{3}
}
...
type AppendEntriesResponse struct {
	...
	ConflictIndex uint64 `protobuf:"varint,3,opt,name=conflict_index,json=conflictIndex,proto3" json:"conflict_index,omitempty"` // First index of conflicting term
	ConflictTerm  uint64 `protobuf:"varint,4,opt,name=conflict_term,json=conflictTerm,proto3" json:"conflict_term,omitempty"`    // Term of conflicting entry
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AppendEntriesResponse) Reset() {
	*x = AppendEntriesResponse{}
	mi := &file_pkg_transport_proto_raft_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendEntriesResponse) Descriptor() ([]byte, []int) {
	return file_pkg_transport_proto_raft_proto_rawDescGZIP(), []int{4}
}
...
type InstallSnapshotRequest struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Term              uint64                 `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`                                                      // Leader's term
	LeaderId          uint64                 `protobuf:"varint,2,opt,name=leader_id,json=leaderId,proto3" json:"leader_id,omitempty"`                              // Leader's ID
	LastIncludedIndex uint64                 `protobuf:"varint,3,opt,name=last_included_index,json=lastIncludedIndex,proto3" json:"last_included_index,omitempty"` // Snapshot replaces all entries up to this index
	...
	Offset            uint64                 `protobuf:"varint,5,opt,name=offset,proto3" json:"offset,omitempty"`                                                  // Byte offset where chunk is positioned
...
func (x *InstallSnapshotRequest) Reset() {
	*x = InstallSnapshotRequest{}
	mi := &file_pkg_transport_proto_raft_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstallSnapshotRequest) Descriptor() ([]byte, []int) {
	return file_pkg_transport_proto_raft_proto_rawDescGZIP(), []int{5}
}
...
func (x *InstallSnapshotResponse) Reset() {
	*x = InstallSnapshotResponse{}
	mi := &file_pkg_transport_proto_raft_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstallSnapshotResponse) Descriptor() ([]byte, []int) {
	return file_pkg_transport_proto_raft_proto_rawDescGZIP(), []int{6}
}
...
var File_pkg_transport_proto_raft_proto protoreflect.FileDescriptor

const file_pkg_transport_proto_raft_proto_rawDesc = "" +
	"\n" +
	"\x1epkg/transport/proto/raft.proto\x12\x04raft\"N\n" +
	"\bLogEntry\x12\x14\n" +
	...
	"\x0fInstallSnapshot\x12\x1c.raft.InstallSnapshotRequest\x1a\x1d.raft.InstallSnapshotResponseB/Z-github.com/aarush/raft-kv/pkg/transport/protob\x06proto3"

var (
	file_pkg_transport_proto_raft_proto_rawDescOnce sync.Once
	file_pkg_transport_proto_raft_proto_rawDescData []byte
)

func file_pkg_transport_proto_raft_proto_rawDescGZIP() []byte {
	file_pkg_transport_proto_raft_proto_rawDescOnce.Do(func() {
		file_pkg_transport_proto_raft_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_transport_proto_raft_proto_rawDesc), len(file_pkg_transport_proto_raft_proto_rawDesc)))
	})
	return file_pkg_transport_proto_raft_proto_rawDescData
}

var file_pkg_transport_proto_raft_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pkg_transport_proto_raft_proto_goTypes = []any{
...
var file_pkg_transport_proto_raft_proto_depIdxs = []int32{
...
func init() { file_pkg_transport_proto_raft_proto_init() }
func file_pkg_transport_proto_raft_proto_init() {
	if File_pkg_transport_proto_raft_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_transport_proto_raft_proto_rawDesc), len(file_pkg_transport_proto_raft_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pkg_transport_proto_raft_proto_goTypes,
		DependencyIndexes: file_pkg_transport_proto_raft_proto_depIdxs,
		MessageInfos:      file_pkg_transport_proto_raft_proto_msgTypes,
	}.Build()
	File_pkg_transport_proto_raft_proto = out.File
	file_pkg_transport_proto_raft_proto_goTypes = nil
	file_pkg_transport_proto_raft_proto_depIdxs = nil
}
